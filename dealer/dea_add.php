<?php 
    ...
    if(isset($_POST['add'])){
        ...
        $cate_id=$_POST['bank_name'];
        $sale_price=$_POST['bank_account'];
        $pro_detail=$_POST['bank_num'];
        ...
        move_uploaded_file ($_FILES["fileupload"]["tmp_name"], $dir.$path_copy);
            $sql="INSERT INTO product VALUES('','$pro_name','$cate_id','$sale_price','$unit_stock','$pro_detail','$dir$newname','$deaid')";
