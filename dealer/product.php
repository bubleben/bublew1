<?php
    ...
    FROM product,category,dealer WHERE product.cate_id=category.cate_id AND product.dea_id=dealer.dea_id AND product.dea_id='$memid'  ORDER BY `product`.`pro_id` ASC";
