...
<body class="">
    ...
    <div class="sidebar" data-background-color="black"  style="background: #2e2e2e">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="./index.php?page=province">
       ...
       <?php
        ...
        switch ($page) {
          ...
          case 'dealer':
              ...
              break;
          case 'dea_edit':
              include 'dea_edit.php';
              break;
          case 'dea_add':
              include 'dea_add.php';
              break;
          case 'dea_save':
              include 'dea_save.php';
              break;
          ...
          case 'member':
              ...
              break;
          case 'mem_edit':
              include 'mem_edit.php';
              break;
          case 'mem_add':
              include 'mem_add.php';
              break;
          case 'mem_save':
              include 'mem_save.php';
              break;
          ...
          //     break;
          // case 'emp_edit':
          //     include 'emp_edit.php';
          //     break;
          // case 'emp_add':
          //     include 'emp_add.php';
          //     break;
          // case 'emp_save':
          //     include 'emp_save.php';
          //     break;
        ...
        case 'Tracking_save':
          ...
          case 'return':
              ...
              break;
          case 'return_edit':
              include 'return_edit.php';
              break;
          case 'return_add':
              include 'return_add.php';
              break;
          case 'return_save':
              include 'return_save.php';
              break;
      ...
      <footer class="footer">
        <div class="container-fluid">
          <div class="copyright float-right">
            ...
            </script>, made with bubblebenz in projcet <i class="material-icons"> favorite</i>
  ...
  <!-- Include a polyfill for ES6 Promises (optional) for IE11, UC Browser and Android browser deaport SweetAlert -->
