<?php
    include '../connect.php';
    $sql="SELECT * FROM `returns` ORDER BY `returns`.`sale_id` ASC";
    $result=$con->query($sql);

    $date=date('d-m-Y');
    $countpro="SELECT amount,SUM(amount) as s_Total FROM returns ";
...
<div id="main" class="container col-xs"  onclick="window.print()">
    ...
    <h3 style="text-align: center;" > รายงานข้อมูลการคืนสินค้า</h3>
        <div class="col-xs-8" style="text-align: right;">
            <p style="text-align:right;">พิมพ์วันที่&nbsp;&nbsp;:&nbsp;&nbsp;<?php echo $date;?>  </p>
            </div>
    <p>
    มีการคืนสินค้าทั้งหมด &nbsp;&nbsp;<?php echo $resultcount ?> &nbsp;&nbsp; ครั้ง
