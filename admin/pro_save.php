<?php
    ...
    $pro_id=$_POST['pro_id'];
        ...
        $sql="UPDATE product SET pro_name='$pro_name',cate_id='$cate_id',sale_price='$sale_price',unit_stock='$unit_stock',pro_detail='$pro_detail',pro_img='$dir$newname',dea_id='$dea_id' WHERE pro_id='$pro_id'";
