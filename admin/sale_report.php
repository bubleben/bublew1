<?php
    include '../connect.php';
    $sql="SELECT * FROM `sale_detail` ORDER BY `sale_detail`.`sale_id` ASC";
    $result=$con->query($sql);

    $date=date('d-m-Y');
    $countpro="SELECT amount,SUM(amount) as s_Total FROM sale_detail";
...
<div id="main" class="container col-xs"  onclick="window.print()">
    ...
    <h3 style="text-align: center;" > รายงานข้อมูลการขายสินค้า</h3>
        <div class="col-xs-8" style="text-align: right;">
            <p style="text-align:right;">พิมพ์วันที่&nbsp;&nbsp;:&nbsp;&nbsp;<?php echo $date;?>  </p>
            </div>
    <p>
   ขายสินค้าไปทั้งหมด &nbsp;&nbsp;<?php echo $resultcount ?> &nbsp;&nbsp;รายการ 
   เป็นจำนวนของสินค้า &nbsp;&nbsp; <?php echo  $resultcountpro['s_Total'] ?> &nbsp;&nbsp;  ชิ้น </p>
    <?php } ?>
    <table class="table"  style="width: 100%;  text-align: center;" >
        <tr>
            <th  style="width: 10%">รหัสการขาย</th>
            <th  style="width: 30%">รหัสสินค้า</th>
            <th  style="width: 15%">จำนวน</th>
            <th  style="width: 10%">ราคาขายต่อหน่วย</th>
            <th  style="width: 15%">รวมค่าสินค้า</th>
            <th  style="width: 10%">ค่าส่ง</th>
